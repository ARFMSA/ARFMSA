...
class ConfigRegression():
    ...
    def __datasetCommonParams(self, args):
        ...
        mosi_mapping = {
                        ...
                        "speechbrain_asr_aligned_train": "MOSI/asr_speechbrain_aligned_50.pkl",
                        "ibm_asr_train": "MOSI/asr_ibm_unaligned_50.pkl",
                        "ibm_asr_aligned_train": "MOSI/asr_ibm_aligned_50.pkl",
                        "xf_asr_train": "MOSI/asr_xf_unaligned_50.pkl",
                        "xf_asr_aligned_train": "MOSI/asr_xf_aligned_50.pkl",
                        "gold_asr_train": "MOSI/asr_gold_unaligned_50.pkl",
                        "unaligned_50":"MOSI/unaligned_50.pkl",
                        "aligned_50":"MOSI/aligned_50.pkl"
                        } 
